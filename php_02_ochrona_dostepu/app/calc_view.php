	...
	<div style="width:90%; margin: 2em auto;">
		...
		<form action="<?php print(_APP_ROOT); ?>/app/calc.php" method="post" class="pure-form pure-form-stacked">
			...
			<fieldset>
				...
				<input id="id_years" type="number" name="years" value="<?php echo isset($years) ? $years : ''; ?>" />
				<label for="id_interest">Oprocentowanie roczne (%): </label>
				<input id="id_interest" type="text" name="interest" value="<?php echo isset($interest) ? $interest : ''; ?>" />
			</fieldset>
